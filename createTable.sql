...
ALTER TABLE albums 
Add CONSTRAINT One_Photo FOREIGN KEY (cover_photo_id, album_id) REFERENCES Photos(photo_id, album_id);
...
CREATE TRIGGER cc_hid_trg
    BEFORE INSERT ON user_current_cities
    FOR EACH ROW
    BEGIN
        SELECT cc_hid_seq.NEXTVAL INTO :NEW.cc_hid FROM DUAL;
    END;
/
